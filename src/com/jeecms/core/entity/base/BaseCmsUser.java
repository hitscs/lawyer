...
public abstract class BaseCmsUser  implements Serializable {
	...
	private java.util.Set<com.jeecms.lawyer.entity.Lawyer> lawyerSet;
	...
	public java.util.Set<com.jeecms.lawyer.entity.Lawyer> getLawyerSet() {
		return lawyerSet;
	}

	public void setLawyerSet(java.util.Set<com.jeecms.lawyer.entity.Lawyer> lawyerSet) {
		this.lawyerSet = lawyerSet;
	}
