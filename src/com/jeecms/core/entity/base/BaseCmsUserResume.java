...
/**
 * This is an object that contains data related to the jc_user_resume table. Do
 * not modify this class because it will be overwritten if the configuration
 * file related to this class is modified.
 *
 * @hibernate.class table="jc_user_resume"
 */
...
public abstract class BaseCmsUserResume implements Serializable {
	 ...
	 */
	public BaseCmsUserResume(java.lang.Integer id, java.lang.String resumeName) {
	 ...
	 * 
	 * @param targetWorknature
	 *            the target_worknature value
	 */
	 ...
	 * 
	 * @param targetWorkplace
	 *            the target_workplace value
	 */
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof com.jeecms.core.entity.CmsUserResume))
			return false;
		else {
			com.jeecms.core.entity.CmsUserResume cmsUserResume = (com.jeecms.core.entity.CmsUserResume) obj;
			if (null == this.getId() || null == cmsUserResume.getId())
				return false;
			else
				return (this.getId().equals(cmsUserResume.getId()));
		}
	}
